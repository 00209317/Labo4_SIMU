...
void leerMallayCondiciones(mesh &m){
    char filename[14];
    ifstream file;
    float l, tao, ka, lamda, mu, israel, alpha, deltha, ene;
    ...
    file >> l >> tao >> ka >> lamda >> mu >> israel >> alpha >> deltha >> ene;
    file >> nnodes >> neltos >> ndirich_u >> ndirich_p;

    
    m.setParameters(l, tao, ka, lamda, mu, israel, alpha, deltha, ene);
