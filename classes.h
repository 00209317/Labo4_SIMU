...
enum parameters {ELEMENT_LENGTH,TAO,KA,LAMDA,MU,ISRAEL,ALPHA,DELTHA,ENE};
...
class mesh{
    ...
    public:
        void setParameters(float l,float tao,float ka,float lamda,float mu,float israel,float alpha,float deltha,float ene){
            parameters[ELEMENT_LENGTH]=l;
            parameters[TAO]=tao;
            parameters[KA]=ka;
            parameters[LAMDA]=lamda;
            parameters[MU]=mu;
            parameters[ISRAEL]=israel;
